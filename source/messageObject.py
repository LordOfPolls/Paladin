...
class Message:
    ...
    def __str__(self):
        data = {'message_id': self._message_id, 'open': self.open, 'guild_id': self.guildID, 'author_id': self.authorID,
                'title': self.title, 'content': self.content}
        return json.dumps(data)

    async def importMessage(self, guildID: int,
    ...
    async def store(self):
        ...
        title = await self.db.escape(json.dumps(self.title))
...
async def getMessage(bot: dataclass.Bot,
                     guildID: int,
                     authorID: typing.Union[None, int] = None,
                     index: typing.Union[None, int] = None):
    """
